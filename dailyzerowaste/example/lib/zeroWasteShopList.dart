...
Widget _buildListItem(BuildContext context, DocumentSnapshot data) {
  ...
  final double km = distance.as(LengthUnit.Kilometer, LatLng(widget.currentLocation.latitude, widget.currentLocation.longitude), LatLng(currentStore.latitude, currentStore.longitude));
